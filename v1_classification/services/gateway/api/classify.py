...
# IOA Observe: session management + context propagation
try:
...
SUGGESTED_PROMPTS = [
    {
        "id": "medical-classify",
        "prompt": "Classify this medical image and identify any abnormalities",
        "description": "Simple medical classification",
        "domain": "medical"
    },
    {
        "id": "medical-evidence",
        "prompt": "Classify this medical image and provide supporting references and evidence for your diagnosis",
        "description": "Classification with literature references",
        "domain": "medical"
    },
    {
...
async def _send_to_planner(task_id: str, request: ClassificationRequest, planner_url: str):
    """Send classification request to planner with observe context propagation"""
    try:
        # Start observe session and propagate tracing context to planner
        headers = {}
